% eeg_matchchans(bd, ix)  - find closest channels in a larger EEGLAB chanlocs structure
...
function [selchans,dists,selocs, bd, ix] = agf_matchchans(bglocs,ltlocs,noplot)
